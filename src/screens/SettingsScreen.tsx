...
import { View, Text, Pressable, ScrollView, Animated, Switch, ActivityIndicator, Dimensions, StyleSheet, Platform, TextInput, Easing, Keyboard, Image } from 'react-native';
...
export function SettingsScreen({ visible, onClose, email, onSignOut, onOpenDietaryProfile, onUpdateProfile }: Props) {
    ...
    // ── Navigation States ──
    const [currentView, setCurrentView] = useState<'main' | 'dietary'>('main');
    const navigationAnim = useRef(new Animated.Value(0)).current; // 0 = main, 1 = dietary
    ...
    const navigateToDietary = () => {
        Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);
        setCurrentView('dietary');
                ...
                <View style={styles.header}>
                    ...
                    >
                        <Animated.View style={{
                            ...
                            <Ionicons name={currentView === 'dietary' ? "chevron-back" : "chevron-down"} size={24} color="#111111" />
                        </Animated.View>
                    </Pressable>
                            ...
                            <View style={styles.section}>
                                ...
                                <View style={styles.settingsGroup}>
                                    ...
                                    <Pressable
                                        ...
                                        onPress={() => {/* TODO: Navigate to ingredients list */ }}
                                    >
                                        <View style={{ flexDirection: 'row', flex: 1 }}>
                                            <View style={{ width: 32, marginTop: 2 }}>
                                ...
                                {displayData.map((item, idx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <Text style={[item.type === 'known' ? forbiddenStyles.optionText : forbiddenStyles.customChipText, !isSelected && forbiddenStyles.optionTextUnselected]}>
                                                {item.label}
                                            </Text>
                                        </WigglePill>
                                    );
